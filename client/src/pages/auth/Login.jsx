...
function LeftPanel() {
  ...
  return (
    ...
    >
      ...
      {/* Floating cards */}
      <div className="absolute top-16 right-12 float-1 pointer-events-none">
        <div
      ...
      <div className="absolute bottom-32 right-8 float-2 pointer-events-none">
        <div
          className="rounded-xl px-4 py-3 text-xs font-medium"
      ...
      <div className="absolute top-1/2 right-16 float-3 pointer-events-none">
        <div
          className="rounded-xl px-4 py-3 text-xs font-medium"
      ...
      <div className="relative z-10 max-w-md">
        ...
        <h2 className="text-3xl font-bold text-white leading-tight mb-4">
          Build ATS-optimized<br />resumes with the<br />
          <span className="text-gradient-blue-cyan">power of AI</span>
        </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  <label htmlFor="password" className="block text-xs font-semibold uppercase tracking-wide" style={{ color: '#94a3b8' }}>
                    Password
                  </label>
                  <button
                    type="button"
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 px-4 mt-1 rounded-lg text-sm font-semibold text-white
